...
import { extractContractNames, hasBinary, parseSolcVersion } from "./binary-utils"
...
describe("binary-utils", () => {
  ...
  describe("parseSolcVersion", () => {
    ...
    it("should extract version from foundry.toml", async () => {
      ...
      writeFileSync(`${testDir}/foundry.toml`, 'solc = "0.8.19"\nother = "value"')
    ...
    it("should extract version from pragma in .sol file", async () => {
      ...
      writeFileSync(`${testDir}/src/Contract.sol`, "pragma solidity ^0.8.20;\n\ncontract Test {}")
    ...
    it("should handle version with caret", async () => {
      ...
      mkdirSync(`${testDir}/src`, { recursive: true })
      writeFileSync(`${testDir}/src/Contract.sol`, "pragma solidity ^0.8.0;\n\ncontract Test {}")
    ...
    it("should handle version with tilde", async () => {
      ...
      mkdirSync(`${testDir}/src`, { recursive: true })
      writeFileSync(`${testDir}/src/Contract.sol`, "pragma solidity ~0.7.6;\n\ncontract Test {}")
